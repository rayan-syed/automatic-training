...
for i in $(seq 1 $NUM_JOBS); do
    ...
    echo "Starting job ${i}:"
    qsub -hold_jid $previous_job_name -j y -N $job_name -o "/projectnb/tianlabdl/rsyed/automatic-training/logs/${BASE_JOB_NAME}_${i}.qlog" -l h_rt=${HOURS_PER_JOB}:00:00 "job.qsub"
done
